...
class DevVersion(val major: Int, val minor: Int, val patch: Int, val buildId: Int) {
...
tasks {
    ...
    val upgradeKotlinDev = register("upgradeKotlinDev") {
        group = "maintenance"
        ...
        doLast {
            ...
            val latestDev = allVersions.firstNotNullOfOrNull { DevVersion.parse(it) }
