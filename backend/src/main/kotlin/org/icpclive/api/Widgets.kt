...
class AdvertisementWidget(val advertisementSettings: AdvertisementSettings) : Widget(WIDGET_ID, location) {
    companion object {
...
class PictureWidget(val pictureSettings: PictureSettings) : Widget(WIDGET_ID, location) {
    companion object {
