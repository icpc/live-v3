...
public data class Problem(
    ...
    @SinceClics(FeedVersion.`2026_01`) public val memoryLimit: Double? = null,
    @SinceClics(FeedVersion.`2026_01`) public val outputLimit: Double? = null,
    @SinceClics(FeedVersion.`2026_01`) public val codeLimit: Double? = null,
    ...
    @SinceClics(FeedVersion.`2026_01`) public val attachments: List<File>? = null,
): ObjectWithId
