...
export const createShimmerStyles = (problemColor?: string, diagonal: boolean = false) => css`
  ...
  animation: ${diagonal ? shimmerAnimationDiagonal : shimmerAnimationHorizontal} 2s linear infinite;
  color: #fff;
  font-weight: bold;
