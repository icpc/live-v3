...
config.SCOREBOARD_TABLE_HEADER_DIVIDER_COLOR = "#242425";
...
config.QUEUE_ROW_TRANSITION_TIME = 1000; // ms
...
config.SCOREBOARD_RANK_WIDTH = "80px"; // px
config.SCOREBOARD_RANK_WIDTH2 = "50px"; // px
config.SCOREBOARD_NAME_WIDTH = "300px"; // px
config.SCOREBOARD_NAME_WIDTH2 = "350px"; // px
config.SCOREBOARD_SUM_PEN_WIDTH = "80px"; // px
config.SCOREBOARD_HEADER_TITLE_BG_COLOR = config.VERDICT_NOK;
config.SCOREBOARD_HEADER_TITLE_BG_GREEN_COLOR = config.VERDICT_OK;
config.SCOREBOARD_HEADER_TITLE_FONT_SIZE = "30px";
config.SCOREBOARD_HEADER_BG_COLOR = "#000000";
config.SCOREBOARD_OPACITY = 0.95;
