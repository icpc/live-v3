...
const ContestantViewVerticalWrap = styled.div<ContestantViewVerticalWrapProps>`
  ...
  grid-template-columns: auto repeat(${props => props.tasks}, ${props => props.taskWidth}px);
...
const TaskRow = styled.div<TaskRowProps>`
  ...
  width: 100%;
  &:nth-child(2) {
    border-radius: ${props => props.$isTop ? c.GLOBAL_BORDER_RADIUS : 0} 0
      0 ${props => props.$isTop ? 0 : c.GLOBAL_BORDER_RADIUS};
  }
`;
