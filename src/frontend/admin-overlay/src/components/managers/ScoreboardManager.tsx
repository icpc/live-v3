...
import { ScoreboardWidgetService } from "@admin/services/scoreboardService.ts";
import ScrollDirectionSwitcher from "@admin/components/controls/ScrollDirectionSwitcher.tsx";
