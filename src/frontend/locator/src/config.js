...
const BACKEND_PORT =
    import.meta.env.VITE_APP_BACKEND_PORT ?? window.location.port;
export const BACKEND_ROOT =
    import.meta.env.VITE_APP_BACKEND_ROOT ??
    BACKEND_PROTO + window.location.hostname + ":" + BACKEND_PORT;
export const BASE_URL_BACKEND =
    import.meta.env.VITE_APP_BACKEND_URL ?? BACKEND_ROOT + "/api/admin";
