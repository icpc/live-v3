...
export const BACKEND_PORT = import.meta.env.VITE_BACKEND_PORT ?? window.location.port;
...
export const EXAMPLES_LOCATION = import.meta.env.VITE_SCHEMAS_LOCATION ?? (BACKEND_ROOT + "/examples");
export const MEDIAS_LOCATION = import.meta.env.VITE_MEDIAS_LOCATION ?? (BACKEND_ROOT + "/media");

export const WS_PROTO = window.location.protocol === "https:" ? "wss://" : "ws://";
