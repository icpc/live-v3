...
class TeamSpotlightServiceTest {
    ...
    private val simpleContestInfo =
        ContestInfo(ContestStatus.RUNNING, ContestResultType.ICPC, Clock.System.now(), 1.hours, 1.hours, simpleProblems, simpleTeams)
    ...
    private fun run(
        ...
        RunInfo(runIdCounter++, isAC, isJudged, !isAC, ContestResultType.ICPC, "", 0, problemId, teamId, 1.0, time, isFts)
