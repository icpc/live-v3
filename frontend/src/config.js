...
// Styles
export const VERDICT_OK = "green";
export const VERDICT_NOK = "red";
export const VERDICT_UNKNOWN = "yellow";
...
export const CELL_BG_COLOR = "black";
export const CELL_BG_COLOR_ODD = "grey";

export const CELL_PROBLEM_LINE_WIDTH = "5px";
export const CELL_QUEUE_VERDICT_WIDTH = "50px"; // px
export const CELL_QUEUE_RANK_WIDTH = "50px"; // px
export const CELL_QUEUE_TOTAL_SCORE_WIDTH = "50px"; // px
export const CELL_QUEUE_TASK_WIDTH = "50px"; // px
